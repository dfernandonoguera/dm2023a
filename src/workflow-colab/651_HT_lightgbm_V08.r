...
PARAM  <- list()
PARAM$experimento  <- "HT6510v08" #cambiar cada vez que se corra el modelo
...
PARAM$lgb_basicos <- list(
   ...
   is_unbalance=  FALSE,           #
   scale_pos_weight= 10.18,        # scale_pos_weight = count(negative examples)/count(Positive examples)
