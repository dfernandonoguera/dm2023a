...
PARAM  <- list()
PARAM$experimento  <- "HT6510vk02" #cambiar cada vez que se corra el modelo

PARAM$exp_input  <- "TS6410vk02"
...
PARAM$lgb_basicos <- list(
   ...
   pos_bagging_fraction= 0.015,    # 0.0 < pos_bagging_fraction <= 1.0
   neg_bagging_fraction= 0.985,    # 0.0 < neg_bagging_fraction <= 1.0
   is_unbalance=  FALSE,           #
