...
PARAM  <- list()
PARAM$experimento  <- "HT6510v04" #cambiar cada vez que se corra el modelo
...
PARAM$lgb_basicos <- list(
   ...
   is_unbalance=  FALSE,           #
   scale_pos_weight= "p_weight",   # scale_pos_weight = count(negative examples)/count(Positive examples)
...
PARAM$bo_lgb <- makeParamSet(
         ...
         makeNumericParam("p_weight",         lower= 0.1,     upper= 1)
        )
