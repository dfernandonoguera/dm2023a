...
PARAM  <- list()
PARAM$experimento  <- "ZZ6910VEK01" #cambiar cada vez que se corra el modelo
PARAM$exp_input  <- "HT6510VEK01"
...
PARAM$semillas  <- c(100559, 100591, 100609, 100613, 100621, 324161, 413411, 537991, 679157, 875161) #reemplazar por las propias semillas
