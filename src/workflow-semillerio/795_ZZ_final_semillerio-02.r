...
PARAM  <- list()
PARAM$experimento  <- "ZZ7950-04"
PARAM$exp_input  <- "HT7510-04"
...
PARAM$semillerio  <- 70   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
