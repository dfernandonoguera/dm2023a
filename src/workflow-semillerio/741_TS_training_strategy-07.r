...
PARAM  <- list()
PARAM$experimento <- "TS7410-07"

PARAM$exp_input  <- "FE7310-06"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

PARAM$future       <- c( 202109 )
PARAM$final_train  <- c( 202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007,202006, 202002, 202001, 201912, 201911 )

PARAM$train$training     <- c( 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007,202006, 202002, 202001, 201912, 201911, 201910, 201909, 201908 )
PARAM$train$validation   <- c( 202106 )
PARAM$train$testing      <- c( 202107, 202012 )
...
PARAM$train$semilla  <- 100559  # cambiar por su propia semilla  !!!
