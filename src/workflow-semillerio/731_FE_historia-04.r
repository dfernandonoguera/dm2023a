...
PARAM  <- list()
PARAM$experimento <- "FE7310-04"

PARAM$exp_input  <- "DR7210-02"

PARAM$lag1  <- TRUE
PARAM$lag2  <- TRUE
PARAM$lag3  <- TRUE #aca lo pongo en true
...
PARAM$RandomForest$semilla  <- 100559    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 100559   # cambiar por la propia semilla
